	...
	},
{
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "The Cheesecake Factory operates full-service casual dining restaurants known for an absurdly large menu and generous portion sizes — plus 50+ varieties of cheesecake." },
				{ heading: "Why Gen Z Cares", content: "The Cheesecake Factory is a cultural institution — the birthday dinner spot, the special occasion go-to. Their menu length is a meme. The bread is practically a religion." },
				{ heading: "The Bigger Picture", content: "Cheesecake Factory also owns North Italia and Fox Restaurant Concepts, expanding beyond their flagship brand. The stock has been a steady compounder driven by consistent same-store sales and smart real estate." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "18x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "reasonable valuation for a consistently profitable restaurant" },
			marketCap: { label: "Market Cap", value: "$2B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap restaurant stock — stable and profitable" },
			revenueGrowth: { label: "Revenue Growth", value: "8%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth from new locations and menu pricing" },
			profitMargin: { label: "Profit Margin", value: "5%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "solid restaurant margins — better than most casual dining" },
			beta: { label: "Beta", value: "1.3", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate swings — tied to consumer spending" },
			dividendYield: { label: "Dividend Yield", value: "2.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "decent income for a restaurant stock" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Texas Roadhouse serves hand-cut steaks, ribs, and comfort food in a lively atmosphere with country music, peanut shells on the floor, and line-dancing servers on weekend nights." },
				{ heading: "Why Gen Z Cares", content: "Texas Roadhouse is one of the few casual dining chains genuinely thriving. Their made-from-scratch food quality at accessible prices has built fierce loyalty — and the stock has dramatically outperformed the restaurant sector." },
				{ heading: "The Bigger Picture", content: "TXRH is one of the best-run restaurant companies in America. They've navigated inflation by absorbing costs rather than over-raising prices — a strategy that's earned customer loyalty and long-term market share gains." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "28x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "premium for the best-run steakhouse chain in the country" },
			marketCap: { label: "Market Cap", value: "$9B", explanation: "The total value of all the company's shares combined", culturalTranslation: "large restaurant stock — one of the biggest casual dining companies" },
			revenueGrowth: { label: "Revenue Growth", value: "14%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "consistent strong growth driven by new locations and same-store sales" },
			profitMargin: { label: "Profit Margin", value: "8%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "excellent margins for full-service casual dining" },
			beta: { label: "Beta", value: "0.9", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "low beta — defensive consumer stock" },
			dividendYield: { label: "Dividend Yield", value: "1.8%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "solid dividend plus regular special dividends" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		vibes: [
			{ name: "Clout", emoji: "🏰", value: 48, color: "#00d9ff" },
			{ name: "Drama Level", emoji: "🎭", value: 22, color: "#ff006e" },
			{ name: "Internet Hype", emoji: "🔥", value: 42, color: "#ff9500" },
		],
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Denny's operates and franchises over 1,500 diners across the US and internationally, serving breakfast all day. The iconic Grand Slam has been on the menu since the 1970s." },
				{ heading: "Why Gen Z Cares", content: "Denny's has leaned into social media in a way no diner brand should be able to — their Twitter/X presence has been absurdly funny. Late-night diner runs are a Gen Z right of passage." },
				{ heading: "The Bigger Picture", content: "Denny's is a franchise-heavy model with high margins but faces headwinds from shifting dining habits. The brand is investing in remodels and off-premise ordering to stay relevant in a delivery-first world." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "12x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "cheap valuation — market prices it as a mature, slow-growth brand" },
			marketCap: { label: "Market Cap", value: "$300M", explanation: "The total value of all the company's shares combined", culturalTranslation: "small-cap — a legacy brand at a low valuation" },
			revenueGrowth: { label: "Revenue Growth", value: "2%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "flat growth — maintaining rather than expanding" },
			profitMargin: { label: "Profit Margin", value: "10%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "high margins from franchise model — low overhead" },
			beta: { label: "Beta", value: "1.4", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility for a small-cap consumer stock" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — using cash for debt reduction" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Jack in the Box operates fast food restaurants primarily in the Western US, known for a diverse menu that includes burgers, tacos, breakfast items, and their famous curly fries — available 24 hours." },
				{ heading: "Why Gen Z Cares", content: "Jack in the Box has a cult following on social media with unhinged marketing content. Their late-night menu and taco deals ($1 tacos!) have made them a staple for night owls and stoners alike." },
				{ heading: "The Bigger Picture", content: "Jack in the Box also owns Del Taco, adding a Mexican fast food brand to their portfolio. The combined company is focusing on franchising and menu innovation to compete in a crowded fast food landscape." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "10x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "cheap — market is skeptical about growth potential" },
			marketCap: { label: "Market Cap", value: "$700M", explanation: "The total value of all the company's shares combined", culturalTranslation: "small-cap fast food with a loyal regional following" },
			revenueGrowth: { label: "Revenue Growth", value: "3%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "modest growth — franchise model maturing" },
			profitMargin: { label: "Profit Margin", value: "12%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "solid franchise margins" },
			beta: { label: "Beta", value: "1.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate-high volatility for a small consumer stock" },
			dividendYield: { label: "Dividend Yield", value: "3.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "high yield — returns cash to shareholders" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Papa John's is the third-largest pizza delivery chain in the US, operating over 5,500 locations worldwide through a franchise model. Known for fresh ingredients and garlic butter dipping sauce." },
				{ heading: "Why Gen Z Cares", content: "Papa John's had one of the most public founder-removal stories in recent corporate history. The brand had to rebuild its identity post-John Schnatter — a case study in corporate crisis management." },
				{ heading: "The Bigger Picture", content: "Papa John's is competing with Domino's and Pizza Hut for delivery market share while also battling third-party delivery apps. International expansion is a key growth driver, with strong momentum in the UK and Middle East." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "22x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "fair value for a recovering brand with franchise upside" },
			marketCap: { label: "Market Cap", value: "$1.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-size restaurant stock in turnaround mode" },
			revenueGrowth: { label: "Revenue Growth", value: "4%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "modest growth as brand rebuilds momentum" },
			profitMargin: { label: "Profit Margin", value: "6%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "decent margins from franchise fees and commissary" },
			beta: { label: "Beta", value: "1.4", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility for a restaurant brand" },
			dividendYield: { label: "Dividend Yield", value: "3.2%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "solid income yield while the brand recovers" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Bloomin' Brands operates Outback Steakhouse, Carrabba's Italian Grill, Bonefish Grill, and Fleming's Prime Steakhouse — covering a range of price points and cuisines under one corporate roof." },
				{ heading: "Why Gen Z Cares", content: "Bloomin' Brands owns the restaurants that defined casual date nights and family dinners for generations. Outback's Bloomin' Onion alone has cultural status. These aren't flashy brands but they're deeply embedded in American dining habits." },
				{ heading: "The Bigger Picture", content: "Bloomin' Brands has a strong Brazil operation through Outback, making it a rare US restaurant stock with meaningful international exposure. Brazil has been a growth engine as middle-class dining expands." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "11x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "value-priced stock for a diversified casual dining portfolio" },
			marketCap: { label: "Market Cap", value: "$1.2B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-size restaurant company with multiple brands" },
			revenueGrowth: { label: "Revenue Growth", value: "5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth from Brazil and menu improvements" },
			profitMargin: { label: "Profit Margin", value: "4%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "typical casual dining margins — volume game" },
			beta: { label: "Beta", value: "1.6", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderately volatile — consumer discretionary exposure" },
			dividendYield: { label: "Dividend Yield", value: "4.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "high yield — income-focused restaurant stock" },
		},
		interestCategories: ["food", "lifestyle"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Brinker International owns Chili's Grill & Bar and Maggiano's Little Italy. Chili's serves American casual dining — the Triple Dipper, Chicken Crispers, and the margarita bar are fan favorites." },
				{ heading: "Why Gen Z Cares", content: "Chili's had one of the most surprising brand revivals in recent years. A $10.99 3 For Me value meal went viral on TikTok, driving massive foot traffic. The stock more than doubled as the brand proved casual dining can compete with fast food on price." },
				{ heading: "The Bigger Picture", content: "Brinker is aggressively taking market share from fast casual by offering better food at competitive prices. Same-store sales have been among the best in casual dining. EAT is a turnaround story that actually worked." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "20x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "re-rated higher as the turnaround became undeniable" },
			marketCap: { label: "Market Cap", value: "$4B", explanation: "The total value of all the company's shares combined", culturalTranslation: "significant re-rating from the TikTok-era comeback" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "one of the strongest growth rates in casual dining" },
			profitMargin: { label: "Profit Margin", value: "7%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "improving margins as value strategy drives volume" },
			beta: { label: "Beta", value: "1.4", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility — consumer spending story" },
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "ACM Research makes semiconductor cleaning and processing equipment used in chipmaking fabs — the critical steps that remove contaminants from wafers during manufacturing. Their tools are used by leading chip manufacturers in China and increasingly globally." },
				{ heading: "Why Gen Z Cares", content: "Every AI chip, every smartphone processor, every GPU needs cleaning equipment to be made correctly. ACM is a picks-and-shovels play on the semiconductor boom — the company selling tools to the companies building the future." },
				{ heading: "The Bigger Picture", content: "ACM has grown revenue rapidly by capturing Chinese semiconductor fab spending. As China accelerates domestic chip production to reduce US dependence, ACM's addressable market expands. US export restrictions create risk but also validate the strategic importance of their technology." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "15x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "cheap for a fast-growing tech company — the market discounts China exposure" },
			marketCap: { label: "Market Cap", value: "$1.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap with room to grow if China semi build-out continues" },
			revenueGrowth: { label: "Revenue Growth", value: "25%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "strong growth driven by China fab investments" },
			profitMargin: { label: "Profit Margin", value: "12%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "solid margins — improving as scale benefits kick in" },
			beta: { label: "Beta", value: "1.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile — moves on US-China trade news and semiconductor cycle" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting in R&D and expansion" },
		},
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Intuitive Machines builds lunar landers, spacecraft, and space infrastructure under NASA's CLPS (Commercial Lunar Payload Services) program. Their IM-1 mission (Odysseus) landed on the moon in February 2024 — the first US landing since Apollo 17 in 1972, and the first private lunar landing ever." },
				{ heading: "Why Gen Z Cares", content: "Odysseus landing on the moon was a global moment — even though it tipped on its side, it worked. LUNR is the publicly traded way to bet on the return to the moon era, NASA contracts, and eventually lunar infrastructure like communication networks and data centers." },
				{ heading: "The Bigger Picture", content: "NASA's Artemis program and the broader lunar economy represent a multi-decade opportunity. Intuitive Machines has follow-on missions contracted, and is building lunar data relay networks. The risk is execution — space is hard and the company is still tiny." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "pre-profit — building out lunar infrastructure takes time" },
			marketCap: { label: "Market Cap", value: "$700M", explanation: "The total value of all the company's shares combined", culturalTranslation: "small-cap moonshot — tiny company with enormous ambitions" },
			revenueGrowth: { label: "Revenue Growth", value: "40%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "growing fast as NASA contracts ramp up" },
			profitMargin: { label: "Profit Margin", value: "N/A", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "burning cash to build lunar capabilities" },
			beta: { label: "Beta", value: "2.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "extremely volatile — small cap space stock moves 20-50% on any news" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — every dollar goes to rockets and landers" },
		},
		interestCategories: ["tech", "science"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Joby Aviation is developing a 5-seat electric vertical takeoff and landing (eVTOL) aircraft designed for urban air mobility — think Uber but through the air. Their aircraft flies at up to 200 mph with a 100-mile range and makes less noise than a conversation at normal speaking volume." },
				{ heading: "Why Gen Z Cares", content: "The concept of booking a flying taxi on your phone to skip LA traffic is genuinely exciting. Delta Air Lines invested $200M in Joby and plans to sell Joby rides through its app. Toyota is also an investor and manufacturing partner, giving Joby serious production credibility." },
				{ heading: "The Bigger Picture", content: "FAA certification is the critical milestone — Joby is further along than any competitor. Commercial service is targeted to launch in 2025. The urban air mobility market is projected to be $100B+ if eVTOL achieves mass adoption. Pre-revenue today, but the potential is enormous." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "pre-revenue — this is a bet on air taxi becoming real" },
			marketCap: { label: "Market Cap", value: "$4B", explanation: "The total value of all the company's shares combined", culturalTranslation: "well-funded pre-revenue company backed by Delta and Toyota" },
			revenueGrowth: { label: "Revenue Growth", value: "N/A", explanation: "How much more money the company is making compared to last year", culturalTranslation: "no commercial revenue yet — in FAA certification phase" },
			profitMargin: { label: "Profit Margin", value: "N/A", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "burning cash on R&D and certification costs" },
			beta: { label: "Beta", value: "1.9", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile pre-revenue stock — moves on FAA certification news" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — needs every dollar to build air taxis" },
		},
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Archer Aviation is building Midnight — a 4-passenger eVTOL aircraft for urban air mobility. Like Joby, it takes off vertically, flies electrically, and aims to connect cities in minutes rather than hours stuck in traffic. United Airlines has ordered up to 200 aircraft and invested in the company." },
				{ heading: "Why Gen Z Cares", content: "Archer is targeting Miami and New York first — two cities where the traffic is genuinely unbearable. United Airlines backing means real distribution and airport infrastructure. Stellantis is the manufacturing partner, adding automotive scale to the production equation." },
				{ heading: "The Bigger Picture", content: "The eVTOL race is a winner-take-most market where FAA certification and airline partnerships are everything. Archer is a step behind Joby on certification but has strong backing. If urban air mobility becomes real, there may be room for multiple players in different city networks." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "pre-revenue startup — pure bet on air taxi future" },
			marketCap: { label: "Market Cap", value: "$2.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "smaller than Joby — more upside potential, more execution risk" },
			revenueGrowth: { label: "Revenue Growth", value: "N/A", explanation: "How much more money the company is making compared to last year", culturalTranslation: "no commercial revenue — still in development and certification" },
			profitMargin: { label: "Profit Margin", value: "N/A", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "deeply negative — spending heavily on aircraft development" },
			beta: { label: "Beta", value: "2.2", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "highly volatile pre-revenue stock" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend" },
		},
		interestCategories: ["tech", "travel"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Globalstar operates a constellation of low-earth orbit satellites providing voice, data, and messaging services. But the big story: Apple chose Globalstar's network for iPhone's Emergency SOS via Satellite feature — meaning every iPhone 14 and later can reach emergency services anywhere on earth via Globalstar." },
				{ heading: "Why Gen Z Cares", content: "Every time an iPhone user sends an SOS from a remote trail or crashed car where there's no cell signal, Globalstar's satellites are involved. Apple has committed hundreds of millions to Globalstar's network expansion. This Apple relationship transformed a niche telecom into a strategic infrastructure play." },
				{ heading: "The Bigger Picture", content: "Apple is funding new Globalstar satellites to handle growing iPhone traffic. The risk is concentration — Apple is the company's dominant revenue source. But if Apple expands satellite features (regular texting, eventually calls), Globalstar's capacity requirements and revenue could expand dramatically." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "40x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "premium valuation reflecting the Apple partnership upside" },
			marketCap: { label: "Market Cap", value: "$2.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap with enormous Apple-driven upside potential" },
			revenueGrowth: { label: "Revenue Growth", value: "30%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "strong growth as Apple satellite features expand" },
			profitMargin: { label: "Profit Margin", value: "8%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "improving margins as fixed satellite infrastructure scales" },
			beta: { label: "Beta", value: "1.7", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderately volatile — moves on Apple news and space sector sentiment" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — investing in satellite network expansion" },
		},
		interestCategories: ["tech"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Las Vegas Sands operates integrated luxury resorts in Macau (6 properties) and Singapore (Marina Bay Sands). They sold all their Las Vegas properties in 2021 to focus entirely on Asia. Marina Bay Sands — with its iconic sky park and infinity pool — is one of the most recognized buildings in the world." },
				{ heading: "Why Gen Z Cares", content: "Marina Bay Sands is literally on every Singapore travel post ever. But beyond the aesthetic, LVS is a pure play on Asia's rising luxury consumer — Chinese tourists gambling in Macau, Southeast Asian wealth, and high-net-worth travelers. The Macau recovery from COVID restrictions drives most of the upside." },
				{ heading: "The Bigger Picture", content: "LVS pays a significant dividend and generates enormous cash flow when Macau and Singapore are running hot. The risk is China policy — Beijing controls Macau casino licensing, and any regulatory crackdown can devastate earnings. The company is also pursuing a new resort in New York and Texas." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "25x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "reasonable for a luxury resort operator with Asia exposure" },
			marketCap: { label: "Market Cap", value: "$35B", explanation: "The total value of all the company's shares combined", culturalTranslation: "large-cap — the biggest US-listed casino operator focused on Asia" },
			revenueGrowth: { label: "Revenue Growth", value: "12%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth as Macau continues recovering toward pre-COVID levels" },
			profitMargin: { label: "Profit Margin", value: "18%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "strong margins — luxury integrated resorts have excellent unit economics" },
			beta: { label: "Beta", value: "1.6", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderately volatile — tied to China policy and Asian consumer spending" },
			dividendYield: { label: "Dividend Yield", value: "2.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "solid dividend — cash flow machine when casinos are running" },
		},
		interestCategories: ["travel", "entertainment"],
	},
	{
		id: "penn",
		ticker: "PENN",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "PENN Entertainment operates 44 gaming and racing properties across 20 US states, plus sports betting via ESPN Bet — built through a deal with Disney that gave ESPN a 1.5% stake in PENN. They're competing head-to-head with DraftKings and FanDuel for the online sports betting market." },
				{ heading: "Why Gen Z Cares", content: "Sports betting is everywhere now, and ESPN Bet is trying to use ESPN's brand power to win. Every major sporting event, every Monday Night Football — ESPN Bet is embedded in the broadcast. The US sports betting market is projected to exceed $40B annually." },
				{ heading: "The Bigger Picture", content: "PENN is fighting an uphill battle — DraftKings and FanDuel have enormous head starts in online sports betting. The ESPN partnership provides brand awareness but converting ESPN viewers to ESPN Bet users has been slower than expected. The regional casino base provides cash flow while they execute the digital transformation." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "losing money on sports betting investments — the casinos are profitable" },
			marketCap: { label: "Market Cap", value: "$3B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap — the market is skeptical of the ESPN Bet strategy" },
			revenueGrowth: { label: "Revenue Growth", value: "5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "modest — digital growth offset by mature casino business" },
			profitMargin: { label: "Profit Margin", value: "N/A", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "negative — ESPN Bet losses outweigh casino profits currently" },
			beta: { label: "Beta", value: "2.0", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile — moves heavily on sports betting market share data" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — cash needed for sports betting build-out" },
		},
		interestCategories: ["gaming", "entertainment"],
	},
	{
		id: "mlco",
		ticker: "MLCO",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Melco Resorts & Entertainment operates integrated luxury resorts in Macau (City of Dreams, Altira, Studio City) and Manila (City of Dreams Manila). Studio City features a figure-eight Ferris wheel on the 35th floor. They are one of only six companies licensed to operate casinos in Macau." },
				{ heading: "Why Gen Z Cares", content: "Macau generates more gambling revenue than Las Vegas, Atlantic City, and Singapore combined. Melco's properties are architectural spectacles — the kind that go viral. As Chinese tourism and luxury spending recover, Macau operators benefit directly. MLCO is a purer Macau play than LVS." },
				{ heading: "The Bigger Picture", content: "The Macau gaming license regime is closely controlled by Beijing — all operators need Beijing's blessing to continue. Melco's concession was renewed through 2032. The recovery of mass-market Chinese gaming tourists post-COVID is the primary driver of the stock." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "18x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "attractive valuation — Macau recovery not fully priced in" },
			marketCap: { label: "Market Cap", value: "$5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-large cap — smaller than LVS but purer Macau exposure" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "recovering strongly as Macau reopens to mainland Chinese tourists" },
			profitMargin: { label: "Profit Margin", value: "12%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "improving margins as high-fixed-cost properties fill up" },
			beta: { label: "Beta", value: "1.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile — heavily tied to Chinese consumer sentiment and policy" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "dividend suspended — focused on debt reduction post-COVID" },
		},
		interestCategories: ["travel", "entertainment"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Boston Beer Company makes Samuel Adams (craft beer), Twisted Tea (hard iced tea), Truly Hard Seltzer (one of the top hard seltzer brands), and Angry Orchard (hard cider). They basically have a brand in every major 'new' drinking category of the past decade." },
				{ heading: "Why Gen Z Cares", content: "Twisted Tea became a cultural phenomenon — the 'Twisted Tea slap' video went viral and genuinely boosted sales. Truly was one of the first big hard seltzers before White Claw took over. SAM is a diversified alcohol portfolio company that bets on what young drinkers want next." },
				{ heading: "The Bigger Picture", content: "The hard seltzer boom went bust faster than expected — Truly lost significant share to White Claw and seltzer fatigue set in. Samuel Adams faces premium beer competition. Twisted Tea is the bright spot — growing consistently. The question is whether SAM can find the next big trend." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "30x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "premium valuation for a beverage company — priced for an eventual trend recovery" },
			marketCap: { label: "Market Cap", value: "$2.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap — smaller than Constellation Brands but focused on premium/craft" },
			revenueGrowth: { label: "Revenue Growth", value: "-5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "declining — hard seltzer volumes are down significantly" },
			profitMargin: { label: "Profit Margin", value: "8%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "compressed margins — higher costs and promotional spending to defend share" },
			beta: { label: "Beta", value: "1.3", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility — defensive consumer staple qualities" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting in brand building" },
		},
		interestCategories: ["food_drink"],
	},
	{
		id: "fizz",
		ticker: "FIZZ",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "National Beverage Corp makes La Croix — the flavored sparkling water that dominated millennial and Gen Z beverage culture in the 2010s. They also make Shasta sodas, Rip It energy drinks, and other beverage brands. But La Croix is the star." },
				{ heading: "Why Gen Z Cares", content: "La Croix tins are aesthetic. The 'Pamplemousse' and 'Coconut' flavors basically became personality descriptors. La Croix created a category — now every beverage company has sparkling water, but FIZZ still rides the strong brand. It's the kind of product that shows up in every trendy apartment fridge." },
				{ heading: "The Bigger Picture", content: "National Beverage is a quirky, family-controlled company that rarely does investor calls. La Croix has faced competition from Bubly (PepsiCo) and AHA (Coca-Cola), but maintained premium positioning. The company generates strong cash flow with minimal debt." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "22x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "fair valuation for a profitable niche beverage brand" },
			marketCap: { label: "Market Cap", value: "$2B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap niche beverage company — La Croix punches above its weight culturally" },
			revenueGrowth: { label: "Revenue Growth", value: "3%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "slow and steady — mature brand with stable demand" },
			profitMargin: { label: "Profit Margin", value: "18%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "excellent margins — simple product, strong brand, low marketing spend" },
			beta: { label: "Beta", value: "0.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "low volatility — defensive consumer staple that moves less than the market" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no regular dividend — but has paid special dividends in the past" },
		},
		interestCategories: ["food_drink"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Keurig Dr Pepper is one of North America's largest beverage companies, combining the Keurig hot and cold beverage system business with an enormous portfolio of drink brands: Dr Pepper, 7UP, Canada Dry, Snapple, Bai, A&W, Sunkist, and more. They merged in 2018 to combine coffee machines with classic soft drinks." },
				{ heading: "Why Gen Z Cares", content: "Dr Pepper has had a serious cultural renaissance — 'I'm a 10 but I drink Dr Pepper' energy. Keurig machines are in virtually every office kitchen and dorm common room. KDP's brands are everywhere in American life, from convenience stores to college campuses." },
				{ heading: "The Bigger Picture", content: "KDP offers stability — diversified across beverages and coffee, with strong market positions in multiple categories. The company pays a solid dividend. Growth is modest, but the portfolio of iconic brands provides pricing power. International expansion is the key growth lever." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "20x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "reasonable for a consumer staples giant — not cheap but not expensive" },
			marketCap: { label: "Market Cap", value: "$45B", explanation: "The total value of all the company's shares combined", culturalTranslation: "large-cap consumer staples — steady and defensive" },
			revenueGrowth: { label: "Revenue Growth", value: "4%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "slow and steady — pricing power and volume growth in developing markets" },
			profitMargin: { label: "Profit Margin", value: "12%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "solid margins improving as integration synergies kick in" },
			beta: { label: "Beta", value: "0.6", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "low volatility — defensive consumer staple stock that holds up in downturns" },
			dividendYield: { label: "Dividend Yield", value: "2.8%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "solid dividend — classic income stock for patient investors" },
		},
		interestCategories: ["food_drink"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "SoundHound AI has built a voice AI platform that powers conversational interfaces for restaurants (drive-through ordering), automotive (in-car voice assistants), customer service, and IoT devices. Their technology lets you talk naturally to machines in noisy environments — critical for fast food and cars." },
				{ heading: "Why Gen Z Cares", content: "SoundHound went from a music recognition app (Shazam competitor) to a serious enterprise AI company. When the AI boom hit, SOUN became a retail investor favorite — one of the first AI-focused stocks you could actually buy. Nvidia disclosed a position in SoundHound, causing the stock to explode." },
				{ heading: "The Bigger Picture", content: "SoundHound's customers include Stellantis, Hyundai, and major restaurant chains. The AI voice market is massive — every car, every fast food drive-through, every call center is a potential customer. But SOUN is small and unprofitable, competing against Amazon, Google, and Apple in voice AI." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "unprofitable — the market is pricing in massive future AI revenue growth" },
			marketCap: { label: "Market Cap", value: "$3B", explanation: "The total value of all the company's shares combined", culturalTranslation: "small-cap AI hype stock — trades on narrative more than fundamentals" },
			revenueGrowth: { label: "Revenue Growth", value: "85%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "explosive revenue growth — real enterprise customers signing up" },
			profitMargin: { label: "Profit Margin", value: "N/A", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "deeply unprofitable — burning cash to scale the platform" },
			beta: { label: "Beta", value: "3.0", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "extremely volatile — retail darling that can move 30% in a day" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — needs every dollar to fund AI development" },
		},
		interestCategories: ["tech"],
	},
// END AUTO-GENERATED
