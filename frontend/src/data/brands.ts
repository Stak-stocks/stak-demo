	...
	},
{
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "eBay connects buyers and sellers for new and used goods worldwide — from vintage sneakers to rare Pokémon cards to literal pallets of Amazon returns." },
				{ heading: "Why Gen Z Cares", content: "Resale culture is Gen Z's love language. eBay is the original thrift flip platform and still dominates collectibles, electronics resale, and niche markets that Amazon can't touch." },
				{ heading: "The Bigger Picture", content: "eBay quietly generates over $2B in profit annually and returns cash to shareholders via buybacks. It's not hypergrowth, but it's a durable, cash-rich business." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "13x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "cheap valuation — market treats it like an old brand with no hype" },
			marketCap: { label: "Market Cap", value: "$28B", explanation: "The total value of all the company's shares combined", culturalTranslation: "massive but underappreciated relative to how much cash it prints" },
			revenueGrowth: { label: "Revenue Growth", value: "3%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "slow and steady — not a growth stock but reliable" },
			profitMargin: { label: "Profit Margin", value: "25%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "extremely profitable marketplace with low overhead" },
			beta: { label: "Beta", value: "1.1", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "mild swings — defensive-ish for a tech company" },
			dividendYield: { label: "Dividend Yield", value: "2.1%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "rare for tech — they pay you to hold it" },
		},
		interestCategories: ["shopping", "tech", "fashion"],
	},
	{
		id: "duol",
		ticker: "DUOL",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Duolingo gamifies language learning with streaks, leaderboards, and an unhinged marketing mascot. 600M+ registered users make it the most downloaded education app on earth." },
				{ heading: "Why Gen Z Cares", content: "Duo the owl became a meme before Duolingo became a stock. Gen Z grew up with streak anxiety and Duo's passive-aggressive notifications. The brand is genuinely funny and self-aware." },
				{ heading: "The Bigger Picture", content: "Duolingo is pivoting to an AI-powered learning platform and expanding into math and music. Revenue growing 40%+ annually with improving unit economics as the subscription base scales." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "115x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "paying a premium for the fastest-growing edtech platform on earth" },
			marketCap: { label: "Market Cap", value: "$14B", explanation: "The total value of all the company's shares combined", culturalTranslation: "valued like a winner — market expects huge TAM expansion" },
			revenueGrowth: { label: "Revenue Growth", value: "40%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "one of the fastest-growing consumer tech companies" },
			profitMargin: { label: "Profit Margin", value: "8%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "newly profitable — investing heavily in AI features" },
			beta: { label: "Beta", value: "1.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile — high growth stocks swing hard" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "all cash goes into growth — zero income" },
		},
		interestCategories: ["tech", "education", "gaming"],
	},
	{
		id: "app",
		ticker: "APP",
		...
		vibes: [
			{ name: "Clout", emoji: "🏰", value: 75, color: "#00d9ff" },
			{ name: "Drama Level", emoji: "🎭", value: 55, color: "#ff006e" },
			{ name: "Internet Hype", emoji: "🔥", value: 92, color: "#ff9500" },
		],
		culturalContext: {
			title: "The Hottest Stock You've Never Heard Of",
			sections: [
				{ heading: "What They Do", content: "AppLovin's AI platform matches mobile ads to users with scary precision. They also own a portfolio of casual mobile games that generate first-party data to train their ad engine." },
				{ heading: "Why Gen Z Cares", content: "Every mobile game ad you've ever seen was probably run through AppLovin. Their AXON AI model is so effective at predicting what users click that revenue nearly doubled in a year." },
				{ heading: "The Bigger Picture", content: "AppLovin is now expanding into e-commerce advertising — putting them in direct competition with Google and Meta for ad dollars. If it works, the TAM explodes." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "65x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "high but justified by the explosive growth trajectory" },
			marketCap: { label: "Market Cap", value: "$100B+", explanation: "The total value of all the company's shares combined", culturalTranslation: "went from $10B to $100B+ in under two years — absurd run" },
			revenueGrowth: { label: "Revenue Growth", value: "70%+", explanation: "How much more money the company is making compared to last year", culturalTranslation: "one of the fastest-growing large-cap companies in the market" },
			profitMargin: { label: "Profit Margin", value: "30%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "highly profitable software margins on an ad network" },
			beta: { label: "Beta", value: "1.7", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "high beta — rides up fast, can drop fast" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting everything into growth" },
		},
		interestCategories: ["tech", "gaming", "media"],
	},
	{
		id: "cvna",
		ticker: "CVNA",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Carvana is an online used car dealer with iconic multi-story glass vending machines for car pickup. They buy, recondition, and sell used cars entirely online." },
				{ heading: "Why Gen Z Cares", content: "Carvana went from $360 per share to under $4 in 2022 as debt piled up — then climbed back above $200. It's one of the most dramatic meme stock comeback stories of all time." },
				{ heading: "The Bigger Picture", content: "The used car market is massive and digitization is inevitable. Carvana's cost structure has improved dramatically as they rightsized operations. The question is whether their debt load remains manageable." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "65x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "paying for the comeback story and future growth potential" },
			marketCap: { label: "Market Cap", value: "$50B", explanation: "The total value of all the company's shares combined", culturalTranslation: "remarkable recovery — back to near peak valuation" },
			revenueGrowth: { label: "Revenue Growth", value: "35%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "accelerating growth as they gain market share" },
			profitMargin: { label: "Profit Margin", value: "2%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "thin margins — high volume business model" },
			beta: { label: "Beta", value: "3.0", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "extremely volatile — not for the faint of heart" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — cash goes to debt reduction" },
		},
		interestCategories: ["tech", "automotive", "shopping"],
	},
	{
		id: "bmbl",
		ticker: "BMBL",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Bumble is a dating app where women must initiate conversations. They also run BFF mode for friendship and Bizz mode for networking — trying to be more than just dating." },
				{ heading: "Why Gen Z Cares", content: "Bumble's brand identity aligns with Gen Z values around female empowerment. But the dating app market has stalled — younger users are burning out on swiping and questioning whether apps actually work." },
				{ heading: "The Bigger Picture", content: "Dating app growth has plateaued industry-wide. Bumble is investing in AI matchmaking and social features to evolve beyond the swipe format. The stock has underperformed since IPO but the brand remains strong." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "not yet consistently profitable" },
			marketCap: { label: "Market Cap", value: "$1.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "significant drop from IPO highs — market skeptical on growth" },
			revenueGrowth: { label: "Revenue Growth", value: "5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "slowing — the dating app market has matured" },
			profitMargin: { label: "Profit Margin", value: "-10%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "still burning cash while investing in product improvements" },
			beta: { label: "Beta", value: "1.4", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderately volatile consumer tech" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no income — growth mode" },
		},
		interestCategories: ["tech", "social", "lifestyle"],
	},
	{
		id: "bros",
		ticker: "BROS",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Dutch Bros operates drive-through coffee stands known for customizable drinks, colorful menus, and a notoriously enthusiastic staff culture. They're expanding aggressively across the US." },
				{ heading: "Why Gen Z Cares", content: "Dutch Bros is a cultural phenomenon. TikTok 'secret menu' orders, Dutch Bros loyalty app, the vibe of the staff — it's become a lifestyle brand as much as a coffee chain." },
				{ heading: "The Bigger Picture", content: "Dutch Bros is still in early expansion — under 1,000 locations vs Starbucks' 16,000+ in the US. If they can maintain unit economics while scaling, the long-term story is compelling." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "60x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "premium valuation for a brand with massive expansion runway" },
			marketCap: { label: "Market Cap", value: "$5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap growth story — lots of room to expand" },
			revenueGrowth: { label: "Revenue Growth", value: "28%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "fast grower — new locations driving consistent revenue gains" },
			profitMargin: { label: "Profit Margin", value: "3%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "thin margins typical for restaurant/retail expansion phase" },
			beta: { label: "Beta", value: "1.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "consumer growth stock — moves with sentiment" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — all money goes to opening new stores" },
		},
		interestCategories: ["food", "lifestyle", "shopping"],
	},
	{
		id: "wing",
		ticker: "WING",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Wingstop is a fast-casual chain focused exclusively on chicken wings. Nearly all locations are franchised, which means high margins and low capital requirements." },
				{ heading: "Why Gen Z Cares", content: "Wingstop is a culture staple — game days, late-night orders, sauce tier lists on social media. The brand has grown significantly by leaning into digital ordering and delivery." },
				{ heading: "The Bigger Picture", content: "Wingstop's franchise model is a cash machine. Digital orders now account for over 65% of sales. International expansion is accelerating. The stock has been one of the best restaurant performers over the past decade." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "40x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "premium for a franchise model that keeps printing cash" },
			marketCap: { label: "Market Cap", value: "$5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "well-established mid-cap restaurant stock" },
			revenueGrowth: { label: "Revenue Growth", value: "20%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "consistent double-digit growth from new locations and digital" },
			profitMargin: { label: "Profit Margin", value: "18%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "exceptional margins for a restaurant — franchise model advantage" },
			beta: { label: "Beta", value: "1.2", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "relatively stable for a growth restaurant stock" },
			dividendYield: { label: "Dividend Yield", value: "0.7%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "modest dividend — mostly returning cash via buybacks" },
		},
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Shake Shack serves premium burgers, fries, shakes, and hot dogs. They started in Madison Square Park in NYC in 2004 and have expanded to 500+ locations worldwide." },
				{ heading: "Why Gen Z Cares", content: "Shake Shack is a social dining experience — Instagram-worthy food, cool locations, collaborations with chefs and brands. It's the fast food option that doesn't feel like fast food." },
				{ heading: "The Bigger Picture", content: "Shake Shack is in aggressive expansion mode with a focus on drive-throughs and digital ordering. International growth, particularly in Asia, is a major part of the long-term story." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "100x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "high valuation for a brand with strong growth but thin restaurant margins" },
			marketCap: { label: "Market Cap", value: "$4B", explanation: "The total value of all the company's shares combined", culturalTranslation: "mid-cap growth restaurant stock" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth from new locations and same-store sales improvement" },
			profitMargin: { label: "Profit Margin", value: "5%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "thin but improving — restaurant economics are hard" },
			beta: { label: "Beta", value: "1.6", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "swings with consumer spending sentiment" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting in expansion" },
		},
		interestCategories: ["food", "lifestyle", "travel"],
	},
	{
		id: "cart",
		ticker: "CART",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Instacart connects shoppers with personal grocery shoppers who pick and deliver orders from local stores. They also provide technology to grocery retailers and run a growing advertising business." },
				{ heading: "Why Gen Z Cares", content: "Instacart normalized grocery delivery for an entire generation. It's table stakes for anyone who values time. Their advertising platform is quietly becoming a major revenue driver as brands target shoppers." },
				{ heading: "The Bigger Picture", content: "The advertising business is Instacart's real moat — grocery data is incredibly valuable for CPG brands. As the delivery market matures, ad revenue becomes the high-margin engine that justifies the valuation." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "25x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "reasonable valuation for a profitable platform with ad upside" },
			marketCap: { label: "Market Cap", value: "$8B", explanation: "The total value of all the company's shares combined", culturalTranslation: "significant step down from private market peak — IPO reality check" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "moderate growth as delivery market normalizes post-pandemic" },
			profitMargin: { label: "Profit Margin", value: "15%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "impressive margins driven by high-margin advertising revenue" },
			beta: { label: "Beta", value: "1.2", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "relatively stable for a tech-adjacent consumer company" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — investing in growth" },
		},
		interestCategories: ["tech", "food", "lifestyle"],
	},
	{
		id: "tm",
		ticker: "TM",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Toyota makes cars for basically everyone — economy Corollas, family Camrys, adventurous 4Runners, luxury Lexus, and pioneered the hybrid market with the Prius." },
				{ heading: "Why Gen Z Cares", content: "Used Toyotas hold their value forever, which means Gen Z's first car is often a Camry or Corolla. Toyota also leads on hybrids at a time when gas prices and EV anxiety coexist." },
				{ heading: "The Bigger Picture", content: "Toyota is the EV skeptic that might be right. Their hybrid-first strategy is gaining ground as consumers hesitate on full EVs. Solid-state battery tech and hydrogen investments could be game-changers." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "10x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "cheap for the world's largest automaker — classic value stock" },
			marketCap: { label: "Market Cap", value: "$250B", explanation: "The total value of all the company's shares combined", culturalTranslation: "one of the largest companies in the world" },
			revenueGrowth: { label: "Revenue Growth", value: "8%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth from a massive global base" },
			profitMargin: { label: "Profit Margin", value: "7%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "solid margins for an automaker at massive scale" },
			beta: { label: "Beta", value: "0.6", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "low volatility — stable large-cap value stock" },
			dividendYield: { label: "Dividend Yield", value: "2.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "pays a real dividend — attractive for income investors" },
		},
		interestCategories: ["automotive", "travel", "sustainability"],
	},
	{
		id: "sony",
		ticker: "SONY",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Sony makes PlayStation consoles and games, produces movies (Spider-Man, Jumanji) and TV, runs one of the world's largest music labels (Beyoncé, Harry Styles, Bad Bunny), and makes premium electronics." },
				{ heading: "Why Gen Z Cares", content: "PS5 is the gaming console of choice for a generation. Sony Music owns the masters for some of the biggest artists alive. If you've streamed it, watched it, or played it — Sony might own a piece of it." },
				{ heading: "The Bigger Picture", content: "Sony's gaming division is the crown jewel and the reason the stock is interesting. PlayStation Network's growing services revenue (PlayStation Plus) creates recurring subscription income that reduces hardware dependency." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "20x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "fair value for a diversified entertainment conglomerate" },
			marketCap: { label: "Market Cap", value: "$130B", explanation: "The total value of all the company's shares combined", culturalTranslation: "large-cap — underappreciated relative to the quality of assets" },
			revenueGrowth: { label: "Revenue Growth", value: "5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth across diversified segments" },
			profitMargin: { label: "Profit Margin", value: "8%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "decent margins for a hardware + entertainment hybrid" },
			beta: { label: "Beta", value: "0.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "relatively stable — diversification buffers volatility" },
			dividendYield: { label: "Dividend Yield", value: "0.5%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "small dividend — focused on reinvestment" },
		},
		interestCategories: ["gaming", "music", "tech", "media"],
	},
	{
		id: "bynd",
		ticker: "BYND",
		...
		vibes: [
			{ name: "Clout", emoji: "🏰", value: 45, color: "#00d9ff" },
			{ name: "Drama Level", emoji: "🎭", value: 80, color: "#ff006e" },
			{ name: "Internet Hype", emoji: "🔥", value: 38, color: "#ff9500" },
		],
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Beyond Meat makes plant-based meat alternatives — burgers, sausages, ground beef — designed to look, cook, and taste like animal meat. Their products are sold in grocery stores and restaurants worldwide." },
				{ heading: "Why Gen Z Cares", content: "Beyond Meat peaked in 2020 when plant-based eating felt like the unstoppable future. The stock hit $235. Then came the reality check — consumers didn't stick with expensive plant meat long-term." },
				{ heading: "The Bigger Picture", content: "Beyond Meat is a survival story now. Revenue has declined significantly. They're cutting costs, focusing on core products, and hoping a renewed interest in sustainability gives them a second act." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "deeply unprofitable — burning cash to survive" },
			marketCap: { label: "Market Cap", value: "$200M", explanation: "The total value of all the company's shares combined", culturalTranslation: "crashed from $15B peak — one of the great pandemic-era implosions" },
			revenueGrowth: { label: "Revenue Growth", value: "-10%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "declining revenue — the plant-based craze has cooled" },
			profitMargin: { label: "Profit Margin", value: "-70%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "for every dollar they make, they spend $1.70 — unsustainable" },
			beta: { label: "Beta", value: "2.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "extremely volatile micro-cap stock" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — needs all cash to survive" },
		},
		interestCategories: ["sustainability", "food", "lifestyle"],
	},
	{
		id: "wrby",
		ticker: "WRBY",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Warby Parker designs and sells eyeglasses and sunglasses directly to consumers, bypassing the traditional eyewear conglomerate (Luxottica) that controls most designer brands. Home try-on is their signature experience." },
				{ heading: "Why Gen Z Cares", content: "Glasses are a fashion statement now, and Warby Parker made stylish frames accessible. Their social mission — donating a pair for every pair sold — aligns with values-driven Gen Z shoppers." },
				{ heading: "The Bigger Picture", content: "Warby Parker is expanding into eye exams and vision care, turning from a glasses retailer into a full vision care company. The vision care TAM is massive and fragmented — huge opportunity if they execute." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "not yet consistently profitable" },
			marketCap: { label: "Market Cap", value: "$1.5B", explanation: "The total value of all the company's shares combined", culturalTranslation: "below IPO price — market wants to see the path to profitability" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth as they expand stores and vision care" },
			profitMargin: { label: "Profit Margin", value: "-5%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "close to breakeven — investing in retail expansion" },
			beta: { label: "Beta", value: "1.3", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility for a small-cap retail stock" },
		...
		interestCategories: ["fashion", "lifestyle", "shopping"],
	},
	{
		id: "gme",
		ticker: "GME",
		...
		vibes: [
			{ name: "Clout", emoji: "🏰", value: 88, color: "#00d9ff" },
			{ name: "Drama Level", emoji: "🎭", value: 99, color: "#ff006e" },
			{ name: "Internet Hype", emoji: "🔥", value: 85, color: "#ff9500" },
		],
		culturalContext: {
			title: "The Stock That Changed Everything",
			sections: [
				{ heading: "What They Do", content: "GameStop sells physical video games, consoles, and electronics at retail stores. They pivoted toward collectibles and memorabilia after gaming went mostly digital." },
				{ heading: "Why Gen Z Cares", content: "In January 2021, Reddit's WallStreetBets coordinated a short squeeze that sent GME from $20 to $483 per share, costing hedge funds billions. It became a cultural moment — a story about collective power vs institutions." },
				{ heading: "The Bigger Picture", content: "GameStop's core retail business is declining as gaming goes digital. Under Ryan Cohen's leadership, the company has accumulated a large cash reserve but hasn't clearly articulated a new direction. It remains a meme stock first." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "minimal earnings — more meme than business fundamentals" },
			marketCap: { label: "Market Cap", value: "$10B", explanation: "The total value of all the company's shares combined", culturalTranslation: "valued way above business fundamentals — pure sentiment and meme premium" },
			revenueGrowth: { label: "Revenue Growth", value: "-5%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "declining — physical game retail is shrinking" },
			profitMargin: { label: "Profit Margin", value: "2%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "barely profitable core business propped up by cash reserves" },
			beta: { label: "Beta", value: "3.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "extreme volatility — moves on tweets, memes, and vibes" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — holding cash while figuring out the future" },
		},
		interestCategories: ["gaming", "tech", "investing"],
	},
	{
		id: "amc",
		ticker: "AMC",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "AMC operates movie theaters across the US and Europe — the largest theater chain in the world by number of screens. AMC A-List subscription offers unlimited movies for a monthly fee." },
				{ heading: "Why Gen Z Cares", content: "AMC became a meme stock alongside GME in 2021. Reddit retail traders piled in, the stock went from $2 to $72, and CEO Adam Aron became oddly beloved on social media. It's a symbol of retail investor solidarity." },
				{ heading: "The Bigger Picture", content: "Theater attendance recovered post-pandemic but remains below 2019 levels. Blockbusters like Barbie, Oppenheimer, and Top Gun proved theatrical is still relevant. AMC's debt load is the key risk to watch." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "not consistently profitable — debt and recovery story" },
			marketCap: { label: "Market Cap", value: "$1B", explanation: "The total value of all the company's shares combined", culturalTranslation: "much lower than meme peak — but still alive" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "recovering as blockbusters bring audiences back" },
			profitMargin: { label: "Profit Margin", value: "-5%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "still burning cash — debt repayment is the priority" },
			beta: { label: "Beta", value: "2.8", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "volatile meme stock — can swing 20% in a day on rumors" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — every dollar goes to debt" },
		},
		interestCategories: ["media", "entertainment", "investing"],
	},
	{
		id: "nio",
		ticker: "NIO",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "NIO designs and manufactures premium electric vehicles in China, with a unique battery swap network that lets drivers swap a depleted battery for a full one in under 5 minutes — no charging wait." },
				{ heading: "Why Gen Z Cares", content: "NIO has the style of Tesla with the tech of Silicon Valley — slick interiors, OTA updates, an ecosystem of services. For retail investors fascinated by the EV revolution beyond TSLA, NIO is the alternative play." },
				{ heading: "The Bigger Picture", content: "NIO faces intense competition in China from BYD, Li Auto, and XPENG, plus geopolitical risk for a Chinese ADR. Their battery swap model is innovative but expensive to scale." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "unprofitable growth company — investing heavily in expansion" },
			marketCap: { label: "Market Cap", value: "$10B", explanation: "The total value of all the company's shares combined", culturalTranslation: "well below pandemic highs — geopolitical and competitive headwinds" },
			revenueGrowth: { label: "Revenue Growth", value: "15%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "growing deliveries as new models launch" },
			profitMargin: { label: "Profit Margin", value: "-20%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "burning significant cash — building out battery swap network is expensive" },
			beta: { label: "Beta", value: "2.0", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "high volatility — moves on China policy, deliveries, and global EV sentiment" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — all capital goes to growth" },
		},
		interestCategories: ["automotive", "tech", "sustainability"],
	},
	{
		id: "chwy",
		ticker: "CHWY",
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Chewy sells pet food, supplies, medications, and vet care online. Their Autoship subscription program locks in recurring revenue from pet owners who just want to not think about running out of kibble." },
				{ heading: "Why Gen Z Cares", content: "Gen Z has pet ownership rates that rival millennials. They treat pets like family members and spend accordingly. Chewy's customer service is legendary — they send handwritten cards when pets pass away." },
				{ heading: "The Bigger Picture", content: "The $150B US pet industry keeps growing regardless of the economy — people don't trade down on their pets. Chewy is expanding into telehealth for pets (Connect With a Vet) and prescription medications." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "30x", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "growth valuation for a company approaching consistent profitability" },
			marketCap: { label: "Market Cap", value: "$7B", explanation: "The total value of all the company's shares combined", culturalTranslation: "below pandemic highs but growing into the valuation" },
			revenueGrowth: { label: "Revenue Growth", value: "10%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "steady growth driven by Autoship subscribers" },
			profitMargin: { label: "Profit Margin", value: "3%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "newly profitable — improving as scale benefits kick in" },
			beta: { label: "Beta", value: "1.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility for a consumer e-commerce stock" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting in growth" },
		},
	...
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Lucid makes ultra-premium electric vehicles. Their Lucid Air sedan has the longest range of any EV on the market (500+ miles) and is genuinely impressive engineering. Saudi Arabia's sovereign wealth fund owns a majority stake." },
				{ heading: "Why Gen Z Cares", content: "Lucid is the anti-Tesla for EV enthusiasts who appreciate engineering over Elon. The company attracts former Tesla engineers and the vehicles receive exceptional reviews — but at $70K+ starting price, the addressable market is narrow." },
				{ heading: "The Bigger Picture", content: "Lucid is burning billions per year and producing under 10,000 cars annually. Saudi backing provides financial runway but the company needs to dramatically increase production volume to have a viable business model." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "deeply unprofitable — costs far exceed revenue" },
			marketCap: { label: "Market Cap", value: "$7B", explanation: "The total value of all the company's shares combined", culturalTranslation: "still valued highly despite massive losses — betting on future volume" },
			revenueGrowth: { label: "Revenue Growth", value: "20%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "growing deliveries from a tiny base" },
			profitMargin: { label: "Profit Margin", value: "-200%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "spending $3 for every $1 of revenue — survival depends on Saudi funding" },
			beta: { label: "Beta", value: "2.2", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "high volatility EV stock — moves big on production updates" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — needs cash to fund operations" },
		},
		interestCategories: ["automotive", "tech", "sustainability"],
	},
	{
		...
		culturalContext: {
			...
			sections: [
				{ heading: "What They Do", content: "Live Nation owns Ticketmaster, operates 265+ venues worldwide, promotes 40,000+ events annually, and manages hundreds of artists through their Live Nation Artists division." },
				{ heading: "Why Gen Z Cares", content: "Taylor Swift's Eras Tour ticket chaos put Live Nation/Ticketmaster on blast like never before. Congress held hearings. The DOJ filed an antitrust lawsuit. Gen Z experienced firsthand how monopoly power manifests in their concert experience." },
				{ heading: "The Bigger Picture", content: "Live experience is one of the few things streaming can't replace. Post-pandemic concert demand has been extraordinary. Despite the antitrust scrutiny, Live Nation's lock on the live events ecosystem makes it a durable business." },
			],
		},
		financials: {
			peRatio: { label: "P/E Ratio", value: "N/A", explanation: "Price-to-Earnings ratio shows how much investors pay for each dollar of profit", culturalTranslation: "complex accounting from promoter advances obscures real earnings" },
			marketCap: { label: "Market Cap", value: "$25B", explanation: "The total value of all the company's shares combined", culturalTranslation: "well-valued for an entertainment monopoly with irreplaceable live event assets" },
			revenueGrowth: { label: "Revenue Growth", value: "20%", explanation: "How much more money the company is making compared to last year", culturalTranslation: "strong growth as live events boom post-pandemic" },
			profitMargin: { label: "Profit Margin", value: "3%", explanation: "What percentage of each sale becomes actual profit", culturalTranslation: "thin margins for a high-revenue business — mostly a volume game" },
			beta: { label: "Beta", value: "1.5", explanation: "How much the stock price swings compared to the overall market", culturalTranslation: "moderate volatility — consumer spending and entertainment sector exposure" },
			dividendYield: { label: "Dividend Yield", value: "0%", explanation: "The percentage of the stock price paid out as dividends each year", culturalTranslation: "no dividend — reinvesting in venues and artist relationships" },
		},
		interestCategories: ["music", "entertainment", "lifestyle"],
	},
// END AUTO-GENERATED
];
