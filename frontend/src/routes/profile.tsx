...
function ProfilePage() {
	...
	if (loading) {
		return (
			<div className="flex items-center justify-center h-full bg-zinc-50 dark:bg-[#0b1121]">
	...
	return (
		<div className="min-h-full bg-white dark:bg-[#0b1121] text-zinc-900 dark:text-white pb-24 relative">
