...
function MyStakPage() {
	...
	const brandDetailOverlay = selectedBrand && (
		...
		>
			...
			{/* Content sheet */}
			<div
				className="relative w-full h-full sm:h-auto sm:max-w-2xl sm:mx-4 bg-[#0b1121] sm:rounded-2xl flex flex-col sm:max-h-[95vh] overflow-y-auto"
			...
			>
				...
				<div className="px-3 pb-3 pt-1 sm:px-6 sm:pb-6 sm:pt-6 flex flex-col">
