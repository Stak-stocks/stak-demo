...
function Root() {
	...
	return (
		<div className="relative flex flex-col h-full bg-white dark:bg-[#0b1121] transition-colors duration-300 overflow-y-auto overflow-x-clip overscroll-y-contain">
			{/* Top header bar */}
			{!isAuthPage && user && (
				<header className="sticky top-0 z-40 flex items-center justify-between px-4 py-3 bg-white dark:bg-[#0b1121]" style={{ border: '0', boxShadow: 'none', outline: '0', borderColor: 'transparent' }}>
