...
const TV_LOGO_SLUGS: Record<string, string> = {
	...
	schw: "schwab", bx: "blackstone", kkr: "kkr",
	aig: "american-international-group", met: "metlife", pru: "prudential",
	afl: "aflac", all: "allstate", cb: "chubb", trv: "travelers",
	adp: "automatic-data-processing", ndaq: "nasdaq", ice: "intercontinental-exchange",
	cme: "cme", spgi: "s-and-p-global", mco: "moodys",
	msci: "msci", trow: "rowe-price", ivz: "invesco",
	...
	// Tech
	orcl: "oracle", ibm: "international-bus-mach", dell: "dell",
	acn: "accenture", sap: "sap", team: "atlassian",
	net: "cloudflare-inc", okta: "okta", ftnt: "fortinet", zs: "zscaler",
	s: "sentinelone", twlo: "twilio", snap: "snap", pins: "pinterest",
	rddt: "reddit", dash: "doordash", meli: "mercadolibre",
	arm: "arm", adi: "analog-devices",
	baba: "alibaba", bidu: "baidu", jd: "jd-com",
	lrcx: "lam-research", mchp: "microchip-technology",
	dkng: "draftkings", pton: "peloton-interactive-inc",
	// Healthcare
	pfe: "pfizer", mrna: "moderna", bmy: "bristol-myers-squibb",
	lly: "eli-lilly", abbv: "abbvie", mrk: "merck-and-co",
	gild: "gilead", amgn: "amgen", regn: "regeneron-pharmaceuticals",
	vrtx: "vertex-pharmaceutical", biib: "biogen", isrg: "intuitive-surgical",
	...
	lulu: "lululemon-athletica", tjx: "tjx-cos", rost: "ross-stores",
	orly: "o-reilly-auto", azo: "autozone", tsco: "tractor-supply",
	dltr: "dollar-tree", dg: "dollar-general", burl: "burlington",
	mar: "marriott", hlt: "hilton-worldwide",
	rcl: "royal-caribbean-cruises", etsy: "etsy",
	// Energy
	eog: "eog", oxy: "occidental-petroleum",
	...
	emr: "emerson", itw: "illinois-tool-works",
	rtx: "raytheon", noc: "northrop-grumman", lhx: "l3-harris",
	ge: "ge-aerospace", mmm: "3m",
	unp: "union-pacific", csx: "csx", ups: "united-parcel",
	fdx: "fedex", dal: "delta-air-lines", ual: "united-airlines",
	luv: "southwest", aal: "american-airlines-group",
	// Telecom
	t: "at-and-t", vz: "verizon", tmus: "t-mobile",
	// Utilities
	duk: "duke-energy", so: "southern", d: "dominion-energy",
	aep: "american-electric-power", exc: "exelon",
	// REITs
	o: "realty-income", amt: "american-tower", eqix: "equinix",
	spg: "simon-property", pld: "prologis", dlr: "digital-realty-trust-5850-series-k-cumulative-redeemable-preferred-stock-par-value-001-per-share",
	// Media / Gaming
	sony: "sony",
	wbd: "warner-bros-discovery", mgm: "mgm-resorts",
	ea: "electronic-arts", ttwo: "take-two-interactive-software", ttd: "the-trade-desk", roku: "roku",
	// Crypto
	mstr: "microstrategy", mara: "marathon-digital-holdings", riot: "riot-blockchain",
	// Consumer Staples
	...
	mlco: "melco", sam: "boston-beer-co", fizz: "national-beverage",
	kdp: "keurig-dr-pepper", soun: "soundhound-ai",
	// Financial services (missing)
	ajg: "gallagher", ally: "ally", amp: "ameriprise-financial",
	aon: "aon", apo: "apollo", ben: "franklin-resources",
	cboe: "cboe-global-markets", cfg: "citizens-financial-group", evr: "evercore",
	fds: "factset-research-systems", fis: "fidelity-information-services", fisv: "fiserv",
	gpn: "global-payments", hig: "hartford-financial-services-grp", key: "keycorp",
	lnc: "lincoln-national", mmc: "marsh-and-mclennan", ncno: "ncino",
	ntrs: "northern-trust", omf: "onemain", pfg: "principal",
	rf: "regions-financial", rjf: "raymond-james", syf: "synchrony",
	tfc: "truist-financial", upst: "upstart", wex: "wex",
	// Tech / Software (missing)
	bill: "bill-com", hpq: "hp", hubs: "hubspot", match: "match-group-inc",
	mpwr: "monolithic-power-system", on: "on-semiconductor", path: "uipath",
	smci: "super-micro-computer", ssnc: "ss-and-c", swks: "skyworks-solutions",
	tost: "toast", u: "unity",
	// Healthcare (missing)
	...
	// Other (missing)
	clsk: "cleanspark", czr: "caesars", nu: "nu-holdings", se: "sea-limited",
